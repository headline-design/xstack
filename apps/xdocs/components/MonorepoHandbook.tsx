  ...
  return (
    <Wrapper>
      ...
      <DetailedFeatureLink
        ...
        href="/docs/handbook/xspaceage-installation"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
          Icon: ChatAlt2Icon,
  ...
  return (
    <Wrapper>
      <DetailedFeatureLink
        feature={{
          Icon: PencilAltIcon,
          description: `Learn how to set up your dev scripts using XBallot.`,
      ...
      <DetailedFeatureLink
        feature={{
          Icon: CodeIcon,
          description:
            "Get framework-specific guides for building your apps with XBallot.",
      ...
      <DetailedFeatureLink
        feature={{
          Icon: DockerIcon,
          description:
            "Make use of XBallot's prune command to keep your Docker deploys fast.",
