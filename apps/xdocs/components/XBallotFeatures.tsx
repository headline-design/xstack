  ...
  return (
    <div className="grid grid-cols-1 mt-12 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:gap-x-8 lg:gap-y-12">
      <DetailedFeatureLink
        ...
        href="/xspace/docs/features/javascript"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
          Icon: TSIcon,
        ...
        href="/xspace/docs/features/typescript"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
          Icon: DownloadIcon,
        ...
        href="/xspace/docs/features/imports"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
        ...
        href="/xspace/docs/features/dev-server"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
          Icon: CSSIcon,
      ...
      <DetailedFeatureLink
        ...
        href="/xspace/docs/features/frameworks"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
          Icon: ServerIcon,
        ...
        href="/xspace/docs/features/static-assets"
      ></DetailedFeatureLink>
      <DetailedFeatureLink
        feature={{
        ...
        href="/xspace/docs/features/environment-variables"
      ></DetailedFeatureLink>
    </div>
  );
};
