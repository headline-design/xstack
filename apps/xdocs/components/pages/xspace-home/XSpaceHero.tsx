...
import XSpaceLogo from "../../logos/XSpaceLogo";

export function XSpaceHero() {
  return (
    <>
      <FadeIn
        noVertical
      ...
      >
        <FadeIn className="z-50 flex items-center justify-center w-full">
          <div className="absolute min-w-[614px] min-h-[614px]">
            <Image
              alt="XSpace"
              src="/images/docs/xspace/xspace-hero-hexagons-dark.svg"
              width={614}
              height={614}
            ...
            <Image
              alt="XSpace"
              src="/images/docs/xspace/xspace-hero-hexagons-light.svg"
              width={614}
              height={614}
        ...
        >
          ...
          />
          <HeroText h1>The Web3-native website builder</HeroText>
          <SectionSubtext hero>
            XSpace is a chain-agnostic website engine and cutting-edge CMS for Web3 builders and communities.
          </SectionSubtext>
        </FadeIn>
        <FadeIn
          delay={0.3}
        ...
        >
          <div className="flex flex-col w-full gap-3 md:!flex-row">
            <CTAButton>
              <Link href="/xspace/docs" className="block py-3">
                Get Started
              </Link>
            </CTAButton>
            <CTAButton outline>
