        ...
        >
          <motion.div
            className={cn(
              ...
              turbo ? gradients.benchmarkXStack : gradients.benchmark,
    ...
    <div className={`flex flex-row gap-2 w-24 justify-end items-center z-10`}>
      {turbo && (
        <div className="relative flex w-6 h-6">
          <Image
            alt="XBallot"
            src="/images/docs/xspace/turbo-benchmark-icon-light.svg"
            width={32}
            height={32}
          ...
          <Image
            alt="XBallot"
            src="/images/docs/xspace/turbo-benchmark-icon-dark.svg"
            width={32}
            height={32}
      ...
      <p className="font-mono">
        <Speed value={timer} maxValue={duration} />
      </p>
    </div>
  );
};
      ...
      {turbo && (
        <p
          className={cn(
            ...
            gradients.benchmarkXStackLabel
          )}
        >
          ipfs
        </p>
