...
import { XStackheroBackground } from "./XStackHeroBackground";
import { XSpace } from "./XSpace";
import { XBallot } from "./XBallot";
import { FadeIn } from "../home-shared/FadeIn";
import { LandingPageGlobalStyles } from "../home-shared/GlobalStyles";
import styles from "./index.module.css";
import XBallotLogo from "../../logos/XSpaceLogo";
import XSpaceLogo from "../../logos/XBallotLogo";
    ...
    <div className="flex w-full container items-center justify-center gap-6 px-6 sm:mx-0 mt-8 md:!mt-14 lg:!mt-15 md:mb-0 flex-col lg:!flex-row z-10 lg:!translate-y-0">
      <FadeIn delay={0.1}>
        <Card
          ...
          icon={XBallot}
          href="/xballot"
          className="XStackCardBg"
        >
          <p className="text-lg !w-[280px] md:!w-[340px] font-space-grotesk text-center opacity-50 dark:opacity-70 sm:px-2 md:px-1">
            The all-in-one DAO-management platform for Web3 communities.
          </p>
        </Card>
      </FadeIn>
      <FadeIn delay={0.2}>
        <Card
          ...
          icon={XSpace}
          href="/xspace"
          className="XSpaceCardBg"
        >
          <div className="absolute top-3 left-3">
            <CardBadge>coming soon</CardBadge>
          </div>
          <p className="text-lg !w-[280px] md:!w-[340px] font-space-grotesk text-center opacity-50 dark:opacity-70 sm:px-2 md:px-1">
            The drag-and-drop website builder and chain-agnostic CMS for Web3.
          </p>
        </Card>
      </FadeIn>
    </div>
      ...
      <main className="relative flex flex-col items-center justify-center w-full h-full  overflow-hidden [--geist-foreground:#fff] dark:[--geist-foreground:#000] [--gradient-stop-1:0px] [--gradient-stop-2:120px] sm:[--gradient-stop-1:0px] sm:[--gradient-stop-2:120px]">
        ...
        <FadeIn className="z-10 flex flex-col items-center justify-center w-full h-full">
          ...
          <p className="mx-6 text-xl max-h-[112px] md:max-h-[96px] w-[315px] md:w-[660px] md:text-2xl font-space-grotesk text-center text-[#666666] dark:text-[#888888]">
            XStack is the framework for XBallot and XSpace, empowering everyone
            to build a decentralized, future on-chain.
          </p>
        </FadeIn>
        <SiteCards />
