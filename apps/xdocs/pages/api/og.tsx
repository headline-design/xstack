...
import XBallotLogo from "../../components/logos/og/XBallotLogo";
import XStackLogo from "../../components/logos/og/XStackLogo";
import XSpaceLogo from "../../components/logos/og/XSpaceLogo";
import HeadlineLogo from "../../components/logos/og/HeadlineLogo";
...
export default async function openGraphImage(
  ...
  try {
    ...
    const title = hasTitle
      ...
      : type === "xballot"
      ? "The governance solution that scales"
      : type === "xspace"
      ? "The Web3-native website builder"
      : "";
    ...
    return new Response(undefined, {
      status: 302,
      headers: {
        Location: "https://xstack.build/og-image.png",
      },
    });
  }
}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", height: 97 * 1.1, alignItems: "center" }}>
        {type === "xballot" ? (
          <XBallotLogo height={85 * 1.1} width={460 * 1.1} />
        ) : type === "xspace" ? (
          <XSpaceLogo height={82 * 1.1} width={420 * 1.1} />
        ) : (
          <XStackLogo height={76 * 1.1} width={420 * 1.1} />
        )}
      </div>
      {title ? (
        <div
      ...
      >
        ...
        <HeadlineLogo fill="white" height={30} />
      </div>
    </div>
  );
}
