...
const LEGACY_REPO_FEATURES: Features = [
  {
    ...
    description: `Building once is painful enough, XBallot will remember what you've built and skip the stuff that's already been computed.`,
    Icon: RefreshIcon,
    page: "all",
  },
  {
    name: "Content-aware hashing",
    description: `XBallot looks at the contents of your files, not timestamps to figure out what needs to be built.`,
  ...
  },
  {
    ...
    description: `XBallot won’t interfere with your runtime code or touch your sourcemaps. `,
    Icon: ChipIcon,
    page: "all",
  },
  {
  ...
  {
    name: "Task pipelines",
    description: `Define the relationships between your tasks and then let XBallot optimize what to build and when.`,
    Icon: ArrowsExpandIcon,
    page: "all",
  },
  {
    name: "Meets you where you’re at",
    description: `Using Lerna? Keep your package publishing workflow and use XBallot to turbocharge task running.`,
    Icon: BeakerIcon,
    page: "home",
  },
  {
